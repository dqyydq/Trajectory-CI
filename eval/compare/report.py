    ...
    for task_id, detail in details.items():
        lines.extend(
            [
                ...
                f"- Score A: {detail.run_a.judge.score if detail.run_a.judge else 'n/a'}",
                f"- Score B: {detail.run_b.judge.score if detail.run_b.judge else 'n/a'}",
                f"- Judge reason A: {detail.run_a.judge.reason if detail.run_a.judge else 'n/a'}",
                f"- Judge reason B: {detail.run_b.judge.reason if detail.run_b.judge else 'n/a'}",
